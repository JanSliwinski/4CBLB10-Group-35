function [averageData] = AverageExperimentData(folderPath,outputfilePath)
...
%outputfilePath = './ExampleDataSet/Data/processed_Data_experiment1.txt';
...
writematrix(averageData, outputfilePath);
